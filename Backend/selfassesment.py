...
class QuizScoreRequest(BaseModel):
    employee_name: str
    skill: str
    level: str  # Corresponds to the difficulty level
    answers: Dict[str, str]  # User answers mapped to questions
    learning_goals: List[Dict]  # List of learning goal questions with correct answers
